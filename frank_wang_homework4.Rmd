...
# Work distrubution:
Since Question set I was discussed in class already, we decided to split the rest of the problems, where we each do two. I will be doing the first two problems from question set ii and Nathan will do the third problem and wrote his own question.
